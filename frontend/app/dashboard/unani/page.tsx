...
function UnaniDashboardContent() {
  ...
  // Debug: Log user data
  useEffect(() => {
    console.log('🔍 Unani Dashboard User Data:', {
      user,
      name: user?.name,
      email: user?.email,
  ...
  return (
    <ProtectedRoute requiredRole="user">
      {/* Background Image - Unani */}
      <div
        className="fixed inset-0 -z-10 w-full h-full"
        style={{
          backgroundImage: "url('/images/frameword_bg/unani.png')",
          ...
          <div className="flex items-center justify-between gap-6">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-slate-500 dark:text-slate-400">Unani Dashboard</p>
              </div>
            </div>
...
export default function UnaniDashboardPage() {
  return (
